...
/* ── Shared product card — used by the /products index grid and the
   RelatedProducts "you may also like" rail. ────────────────────── */
export default function ProductCard({ product }: { product: PruProduct }) {
  return (
    ...
    >
      <p className="text-[11px] font-bold uppercase tracking-widest mb-2" style={{ color: PRU_RED }}>
        {product.category === 'vul' ? 'Investment-Linked' : product.category === 'traditional' ? 'Traditional' : 'Insurance'} Plan
      </p>
